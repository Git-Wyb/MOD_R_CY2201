...
void ADF7030_RECEIVING_FROM_POWEROFF_testMode(void)
{
    ...
    PROFILE_CH_FREQ_32bit_200002EC = 429450000;                                                            //426075000;
    ADF7030_WRITE_REGISTER_NOPOINTER_LONGADDR_MSB(ADDR_CHANNEL_FERQUENCY, PROFILE_CH_FREQ_32bit_200002EC); //
    PROFILE_RADIO_DATA_RATE_32bit_200002FC = 0x64000060;                                                   //0x6400000C; 1.2kbps  //0x64000018; 2.4kbps  //0x64000030; 4.8kbps  //0x64000060; 9.6kbps
    ADF7030_WRITE_REGISTER_NOPOINTER_LONGADDR_MSB(0x200002FC, PROFILE_RADIO_DATA_RATE_32bit_200002FC);
    WaitForADF7030_FIXED_DATA(); //�ȴ�оƬ����/�ɽ���CMD״̬
    DELAY_30U();
    ADF7030_Clear_IRQ();
    GET_STATUE_BYTE();
...
*/
        case 1:
            ...
            if (Flag_TX_ID_load == 0)
                ...
                ADF7030Cfg_pointer = ADF7030Cfg_load;
            break;
        case 2:
            PROFILE_CH_FREQ_32bit_200002EC = 426075000;
            PROFILE_RADIO_AFC_CFG1_32bit_2000031C = 0x0005005A;
...
void APP_TX_PACKET(void)
{
    ...
    {
        for (j = 0; j < 8; j++)
            Last_Uart_Struct_DATA_Packet_Contro.data[j / 2].uc[j % 2] = 0x00;
